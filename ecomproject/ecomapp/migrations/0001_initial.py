    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catagory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecomapp.catagory')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order Received', 'Order Received'), ('Order Processing', 'Order Processing'), ('On the way', 'On the way'), ('Order Compeleted', 'Order Completed'), ('Order Canceled', 'Order Canceled')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
